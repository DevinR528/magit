...
impl RenameRule {
    ...
    pub fn apply_to_variant(&self, variant: &str) -> String {
        match *self {
            ...
            MatrixErrorCase => {
                String::from("M_") + &ScreamingSnakeCase.apply_to_variant(variant)
            }
            MatrixSnakeCase => String::from("m.") + &SnakeCase.apply_to_variant(variant),
            MatrixDottedCase => {
                String::from("m.")
                    + &SnakeCase.apply_to_variant(variant).replace('_', ".")
            }
        }
    }
    ...
    pub fn apply_to_field(&self, field: &str) -> String {
        match *self {
            ...
            MatrixErrorCase => {
                String::from("M_") + &ScreamingSnakeCase.apply_to_field(field)
            }
...
fn rename_variants() {
    for &(
        ...
        (
            "Z42", "z42", "Z42", "z42", "z42", "Z42", "z42", "Z42", "M_Z42", "m.z42",
            "m.z42",
        ),
    ] {
