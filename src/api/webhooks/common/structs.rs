...
pub struct PullRequest<'a> {
    ...
    ///
    /// If the pull request was merged this is the merge commit, if squashed this is the
    /// squash commit, and if rebased this is the commit that the base branch was
    /// updated to.
